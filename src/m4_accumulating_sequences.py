...
def run_test_make_simple_list():
    ...
    actual = make_simple_list(70, 74)
    print('Expected:', expected)
    print('Actual:  ', actual)

    expected = [2]
    actual = make_simple_list(2, 2)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    expected = '5-6-7-8'
    actual = make_less_simple_string(5, 8)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        rectangles.append(circles[k].get_bounding_box())
    return rectangles
